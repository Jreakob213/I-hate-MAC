...
class DlgToggleApp(Gtk.Dialog):
    def _init_(self, parent, exists, appid, name):
        Gtk.Dialog._init_(self, "Install appmanifest", parent, 0)
...
class DlgManual(Gtk.Dialog):
    def _init_(self, parent):
        Gtk.Dialog._init_(self, "Manually install appmanifest", parent, 0,
...
class AppManifest(Gtk.Window):
    def _init_(self):
        Gtk.Window._init_(self, title="appmanifest.acf Generator")
